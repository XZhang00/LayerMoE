...
OUTPUT_DIR=$ROOT_DIR/outputs/12B-layermoe-g1_base_g2
LOG_PATH=$ROOT_DIR/logs/train-stage1-12B-layermoe-g1_base_g2.log
...
OLD_PATH=your_path/LayerMoE/LLaMA-Factory/outputs/6B-layermoe-g2-stage2
...
/opt/anaconda3/envs/layermoe-qwen/bin/deepspeed --num_gpus ${GPU_NUM} --master_port=9902 $ROOT_DIR/src/train_bash.py \
    ...
    --finetuning_type moe \
    --topk 2 \
    --ada_moe_num_experts_list 9,8,6,8,7,5,3,5,5,4,3,3,3,3,3,5,5,5,6,6,6,6,3,3 \
    --aux_loss_coef 0.01 \
    --do_train \

...
OUTPUT_DIR=$ROOT_DIR/outputs/12B-layermoe-g1_base_g2-stage2
LOG_PATH=$ROOT_DIR/logs/train-stage2-12B-layermoe-g1_base_g2.log
...
STAGE1_PATH=your_path/LayerMoE/LLaMA-Factory/outputs/12B-layermoe-g1_base_g2
...
/opt/anaconda3/envs/layermoe-qwen/bin/deepspeed --num_gpus 8 --master_port=9902 $ROOT_DIR/src/train_bash.py \
    ...
    --old_moe_num_experts_list 9,8,6,8,7,5,3,5,5,4,3,3,3,3,3,5,5,5,6,6,6,6,3,3 \

...
OUTPUT_DIR=$ROOT_DIR/outputs/6B-layermoe-g2-8GPUs
LOG_PATH=$ROOT_DIR/logs/train-stage1-6B-layermoe-g2-8GPUs.log
...
/opt/anaconda3/envs/layermoe-qwen/bin/deepspeed --num_gpus ${GPU_NUM} --master_port=9902 $ROOT_DIR/src/train_bash.py \
    ...
    --finetuning_type moe \
    --topk 2 \
    --ada_moe_num_experts_list 5,5,4,5,4,3,2,3,3,3,2,2,2,2,2,3,3,3,3,3,3,3,2,2 \
    --aux_loss_coef 0.01 \
    --do_train \

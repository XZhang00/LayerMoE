...
OUTPUT_DIR=$ROOT_DIR/outputs/6B-layermoe-g2-stage2
LOG_PATH=$ROOT_DIR/logs/train-stage2-6B-layermoe-g2.log
...
STAGE1_PATH=your_path/LayerMoE/LLaMA-Factory/outputs/6B-layermoe-g2-8GPUs
...
/opt/anaconda3/envs/layermoe-qwen/bin/deepspeed --num_gpus 8 --master_port=9905 $ROOT_DIR/src/train_bash.py \
    ...
    --old_moe_num_experts_list 5,5,4,5,4,3,2,3,3,3,2,2,2,2,2,3,3,3,3,3,3,3,2,2 \

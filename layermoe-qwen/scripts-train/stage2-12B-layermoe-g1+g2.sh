...
OUTPUT_DIR=$ROOT_DIR/outputs/12B-layermoe-g1+g2-stage2
LOG_PATH=$ROOT_DIR/logs/train-stage2-12B-layermoe-g1+g2.log
...
STAGE1_PATH=your_path/LayerMoE/LLaMA-Factory/outputs/12B-layermoe-g1+g2-8GPUs
DATASET=el2b,hu2b,tr2b,bn2b,hi2b,ne2b,en50k,zh50k,es50k

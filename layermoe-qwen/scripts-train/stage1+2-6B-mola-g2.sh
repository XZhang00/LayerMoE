...
OUTPUT_DIR=$ROOT_DIR/outputs/6B-base-mola-g2-8GPUs
LOG_PATH=$ROOT_DIR/logs/train-stage1-6B-base-mola-g2-8GPUs.log
...
/opt/anaconda3/envs/layermoe-qwen/bin/deepspeed --num_gpus ${GPU_NUM} --master_port=9902 $ROOT_DIR/src/train_bash.py \
    ...
    --finetuning_type moe \
    --topk 2 \
    --ada_moe_num_experts_list 2,2,2,2,2,2,4,4,4,4,4,4,6,6,6,6,6,6,8,8,8,8,8,8 \
    --aux_loss_coef 0.01 \
    --do_train \
...
ROOT_DIR=your_path/LayerMoE/LLaMA-Factory
MODEL_PATH=your_path/Models/Qwen/Qwen1.5-1.8B
OUTPUT_DIR=$ROOT_DIR/outputs/6B-base-mola-g2-stage2
LOG_PATH=$ROOT_DIR/logs/train-stage2-6B-base-mola-g2.log
...
STAGE1_PATH=your_path/LayerMoE/LLaMA-Factory/outputs/6B-base-mola-g2-8GPUs

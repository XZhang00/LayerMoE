...
OUTPUT_DIR=$LLaMA_DIR/outputs-llama3.2-3B/G1-6B-base-3experts
LOG_PATH=$LLaMA_DIR/logs-llama3.2-3B/train-stage1-G1-6B-base-3experts.log
...
LLaMA_DIR=your_path/layermoe-llama
MODEL_PATH=your_path/Models/meta-llama/Llama-3.2-3B
OUTPUT_DIR=$LLaMA_DIR/outputs-llama3.2-3B/G1-6B-base-3experts-stage2
LOG_PATH=$LLaMA_DIR/logs-llama3.2-3B/train-stage2-G1-6B-base-3experts.log
...
STAGE1_PATH=your_path/layermoe-llama/outputs-llama3.2-3B/G1-6B-base-3experts
...
PEFT_MODEL_PATH=your_path/layermoe-llama/outputs-llama3.2-3B/G1-6B-base-3experts-stage2
